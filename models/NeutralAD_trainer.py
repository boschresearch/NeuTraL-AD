    ...
    def train(self, train_loader,max_epochs=100, optimizer=None, scheduler=None,
        ...
        for epoch in range(1, max_epochs+1):
            ...
            if test_loader is not None:
                test_auc, test_ap,test_f1, testin_loss,testout_loss = self.detect_outliers(test_loader)

            if validation_loader is not None:
                val_auc, val_ap,val_f1, valin_loss,valout_loss = self.detect_outliers(validation_loader)
                if epoch>10:
